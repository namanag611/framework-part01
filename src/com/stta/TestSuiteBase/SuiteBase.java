...
public class SuiteBase {
	...
	public void init() throws IOException {
		...
		// Initializing Test Suite List(TestSuiteList.xls) File Path Using
		...
		// Initializing Test Suite One(SuiteOne.xls) File Path Using Constructor
		// Of Read_XLS Utility Class.
		TestCaseListExcelOne = new Read_XLS(
				System.getProperty("user.dir") + "\\src\\com\\stta\\ExcelFiles\\SuiteOne.xls");
		// Initializing Test Suite Two(SuiteTwo.xls) File Path Using Constructor
		// Of Read_XLS Utility Class.
		TestCaseListExcelTwo = new Read_XLS(
				System.getProperty("user.dir") + "\\src\\com\\stta\\ExcelFiles\\SuiteTwo.xls");
